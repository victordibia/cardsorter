  ...
  <div class="col-xs-12 ">
	  <div class="box box-pricing">
			...
			<div class="box-content no-padding">
				...
				<div class="col-xs-12 bg-default darkborder">
					<div class="col-sm-12">
						
						<?php do { ?>
					    <div class="checkbox col-sm-3">
						    <label>
						      <input type="checkbox" class="form-control" data-toggle="tooltip"  title="Tooltip for name"> <?php echo $row_rsconstructs['title']; ?>
