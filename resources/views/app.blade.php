    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('/') }}" class="logo">
          ...
          <span class="logo-lg"><b>card</b>SORTER</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview " id="tasks"><a href="{{ url('/tasks') }}">  <i class="fa fa-briefcase"></i><span>Tasks</span></a></li>
          </ul>
          <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
         <strong>Copyright &copy; 2014-2015 <a href="http://victordibia.com"> Victor Dibia </a> .</strong> All rights reserved.
      </footer>
